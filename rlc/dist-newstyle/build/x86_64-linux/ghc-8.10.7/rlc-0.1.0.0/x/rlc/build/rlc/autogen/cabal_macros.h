...
/* package rlc-0.1.0.0 */
#ifndef VERSION_rlc
#define VERSION_rlc "0.1.0.0"
#endif /* VERSION_rlc */
#ifndef MIN_VERSION_rlc
#define MIN_VERSION_rlc(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_rlc */
...
#define CURRENT_COMPONENT_ID "rlc-0.1.0.0-inplace-rlc"
