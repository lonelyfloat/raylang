...
/* package raylang-0.1.0.0 */
#ifndef VERSION_raylang
#define VERSION_raylang "0.1.0.0"
#endif /* VERSION_raylang */
#ifndef MIN_VERSION_raylang
#define MIN_VERSION_raylang(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_raylang */
...
#define CURRENT_COMPONENT_ID "raylang-0.1.0.0-inplace-raylang"
